/******************************************************************************************
Updating code for Q4 posix_clock.c on basis of Sam siewart code pthread.c and lab1.c of VxWorks


Q- Code the Fib10 and Fib20 synthetic load
...
changes made by @Chinmay Shah(chinmay.shah@colorado.edu)
*********************************************************************************************/
#include <pthread.h>
#include <stdio.h>
#include <sched.h>
...
void *delay_test(void *threadID)
{
  ...
  //and clock_settime() retrieve and set the time of the specified clock clk_id
